...
def regressor(X_ftrain,train_utilities,X_ftest,test_utilities,fout):
	fout.write("------SLR------"+"\n")
...
print "adjectives"
regressor(trainadj,train_utilities,testadj,test_utilities,fout)

fout.write("------------SHALLOW SYNTACTIC FEATURES--------------\n")
print "syntacs"
regressor(trainsyntac,train_utilities,testsyntac,test_utilities,fout)

fout.write("-------------CLUSTERING------------------------\n")
print "distances"
regressor(traindist,train_utilities,testdist,test_utilities,fout)

fout.write("--------------LEXICAL SUBJECTIVE CLUES + SHALLOW SYNTACTIC FEATURES--------------\n")
print"adj+syntac"
regressor(np.concatenate((trainadj,trainsyntac),axis=1),train_utilities,np.concatenate((testadj,testsyntac),axis=1),test_utilities,fout)

fout.write("--------------LEXICAL SUBJECTIVE CLUES + SHALLOW SYNTACTIC FEATURES + CLUSTERING--------------\n")
print "all togethert"
regressor(X_ftrain,train_utilities,X_ftest,test_utilities,fout)
